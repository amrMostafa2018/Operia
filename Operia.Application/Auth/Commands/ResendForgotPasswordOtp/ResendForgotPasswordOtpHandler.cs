...
public sealed class ResendForgotPasswordOtpHandler : IRequestHandler<ResendForgotPasswordOtpCommand>
{
    private readonly IIdentityService _identityService;
    private readonly IOtpService _otpService;

    public ResendForgotPasswordOtpHandler(IIdentityService identityService, IOtpService otpService)
    {
