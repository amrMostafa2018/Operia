...
public sealed class VerifyOtpHandler : IRequestHandler<VerifyOtpCommand, VerifyLoginOtpResultDto>
{
    private readonly IOtpService _otpService;
    private readonly ITokenService _tokenService;
    private readonly IIdentityService _identityService;

    public VerifyOtpHandler(IOtpService otpService, ITokenService tokenService, IIdentityService identityService)
    {
